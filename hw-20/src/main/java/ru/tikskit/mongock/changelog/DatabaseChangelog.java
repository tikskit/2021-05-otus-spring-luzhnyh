...
public class DatabaseChangelog {
    ...
    public void insertAuthors(MongoDatabase db) {
        MongoCollection<Document> authorsCollection = db.getCollection("authors");
        var vasilyev = new Document().append("name", "Владимир").
                append("surname", "Васильев");
        var lukyanenko = new Document().append("name", "Сергей").
                append("surname", "Лукьяненко");
        authorsCollection.insertMany(List.of(vasilyev, lukyanenko));
    }
}
