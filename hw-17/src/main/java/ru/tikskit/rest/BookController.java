...
public class BookController {
    ...
    public BookController(DBBookService bookService, DBAuthorService authorService, DBGenreService genreService,
                          CommentConverter commentConverter, BookConverter bookConverter) {
